...
We are going to dive deeper into some genes and proteins to gain novel
insights. For our lab today we are focusing on the HOXA1 gene
...
23222703](https://www.ncbi.nlm.nih.gov/pubmed/23222703)
...
![](Class14Lab_files/figure-commonmark/unnamed-chunk-3-1.png)
...
```
    ...
    Info: Working in directory C:/Users/micha/OneDrive/Desktop/BIMM 143/Class16/bimm143_github/Class 14
...
Q: What pathway has the most significant “Entities p-value”? Do the most
significant pathways listed match your previous KEGG results? What
factors could cause differences between the two methods?

The cell cycle has the most significant “Entities p-value” of 2.63E-5.
Looking at the KEGG results we see the cell cycle is also highlighted,
but with a smaller p-value at 8.995727E-6. The difference come from the
fact that KEGG has a smaller with more focused data set that cause any
overlap to be more significant in comparison to the broader reactome
dataset which causes a loss in significance.

## GO Online

![](Screenshot%202026-05-18%20092137.png)
